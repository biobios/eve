...
## 🎯 プロ- `src/`: TypeScriptソースコード（総計約3,360行 - crypto-utilsリファクタリング後）
...
*最終更新: 2025年8月7日*  
*プロジェクトバージョン: 1.0.0*  
*総コード行数: 約3,360行（crypto-utilsリファクタリング後）*  
*対応Node.js: v14以上*  
*対応Electron: ^37.2.5*  
*リファクタリング完了: DatabaseManager系（2025年8月7日）、crypto-utils系（2025年8月7日）*
